...
export const COPY = {
  ...
  account: {
    dangerTitle: '회원 탈퇴',
    dangerDesc:
      '탈퇴하면 반려견 정보·추천 이력·방문 인증·저장 목록과 업로드한 사진이 즉시 삭제됩니다. 계정은 30일 뒤 완전히 파기됩니다.',
    keepNotice: '작성하신 후기는 다른 이용자를 위해 남지만, 누가 썼는지 알 수 없게 처리됩니다.',
    confirmLabel: (text: string) => `계속하려면 아래에 "${text}" 를 입력해 주세요.`,
    confirmPlaceholder: '탈퇴합니다',
    submit: '탈퇴하기',
    submitting: '처리 중…',
    done: '탈퇴가 완료되었습니다. 반려견 정보·추천 이력·사진이 삭제되었고, 계정은 30일 뒤 완전히 파기됩니다. 이용해 주셔서 감사합니다.',
