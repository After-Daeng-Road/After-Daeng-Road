  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-10">
      ...
      <article className="prose prose-sm max-w-none space-y-4 text-sm text-body">
        ...
        <section>
          <h2 className="font-semibold text-ink">제2조 (회원가입 및 인증)</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold text-ink">제3조 (펫 헬스 정보 분리 동의)</h2>
          <p>
        ...
        <section>
          <h2 className="font-semibold text-ink">제4조 (위치 정보)</h2>
          <p>
